...
try:
	...
	_geohash = None
__version__ = "0.8.5"
__all__ = ['encode','decode','decode_exactly','bbox', 'neighbors', 'expand', 'from_ord`']
...
def from_long_value(val, precision):
	return decode_uint64(val)

def from_ord(val, precision=60):
	MAX_BIT_PRECISION = 64
	insignificant_bits = MAX_BIT_PRECISION - precision;
	return from_long_value(val << insignificant_bits, precision);
